...
public interface ServerResource {
    ...
    @Path("remove/{id}")
    @GET
    String removeServer(@PathParam("id") int id);
    ...
    @GET
    String newServer(@PathParam("ip") String ip, @PathParam("hostname") String hostname,
    ...
    */
    ...
    @GET
    List<Servidores> fullServerVerification(@Context HttpServletResponse response);
    ...
    @GET
    List<Servidores> notFullServerVerification(@Context HttpServletResponse response);
    ...
    @GET
    Servidores singleServerVerification(@PathParam("id") int id) throws IllegalVendorException;
}