...
public interface DataBaseResource {
    ...
    @Path("remove/{id}")
    @GET
    String removeDatabase(@PathParam("id") int id);
    ...
    @GET
    String addDatabase(@PathParam(value = "ip") String ip, @PathParam("hostname") String hostname,
    ...
    @GET
    String addDatabaseSqlServer(@PathParam(value = "ip") String ip, @PathParam("hostname") String hostname,
                                @PathParam(value = "dbInstance") String dbInstance, @PathParam(value = "username") String username,
                                @PathParam(value = "password") String password, @PathParam(value = "dbVendor") String dbVendor,
    ...
    @GET
    List<BancoDados> fullDbVerification(@Context HttpServletResponse response);
    ...
    @GET
    List<BancoDados> notFullDbVerification(@Context HttpServletResponse response);
    ...
    @GET
    BancoDados singleDbVerification(@PathParam("id") int id) throws IllegalVendorException;
}