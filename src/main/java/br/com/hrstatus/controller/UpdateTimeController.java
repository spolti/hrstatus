...
public class UpdateTimeController {
    ...
    private Logger log = Logger.getLogger(UpdateTimeController.class.getName());
    ...
    public void updateTimeSelectedClients(String ids) throws JSchException, IOException {
        ...
        final String []servidores = ids.split(",");
    ...
    public void updateTimeAllClients() throws JSchException, IOException {
        ...
        final String ntpAddress = configurationDAO.getNtpServerAddress();

        //Listing all outdated servers
        final List<Servidores> tempServer = this.iteracoesDAO.getServersNOK();
