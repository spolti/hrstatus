...
public class DeleteController {
    ...
    private Logger log = Logger.getLogger(DeleteController.class.getName());
    ...
    public void deleteServerByID(String id_server) {
        ...
        final int id = Integer.parseInt(id_server);
        final Servidores server = this.iteracoesDAO.getServerByID(id);
    ...
    public void deleteDataBaseByID(String id_dataBase) {
        ...
        final int id = Integer.parseInt(id_dataBase);
        final BancoDados dataBase = this.BancoDadosDAO.getDataBaseByID(id);
    ...
    public void deleteLockByID(String id_lock) {
        ...
        final Lock lock = this.lockDAO.getLockByID(Integer.parseInt(id_lock));
