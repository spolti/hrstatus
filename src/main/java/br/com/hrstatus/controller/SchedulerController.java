...
public class SchedulerController {
    ...
    private Logger log = Logger.getLogger(SchedulerController.class.getName());
    ...
    public void scheduler() {
        ...
        final List<VerificationScheduler> scheduler = this.schedulerDAO.schedulers();
    ...
    public void listScheduler() {
        ...
        final List<VerificationSchedulerHistory> schedulerHistory = this.schedulerDAO.getSchedulerHistory(userInfo.getLoggedUsername());
    ...
    public void updateScheduler(VerificationScheduler scheduler, String isDefaultScheduler, String isEveryday, String isEnabled) {
        ...
        //Sending information to the "About" page
        final String version = PropertiesLoaderImpl.getValor("version");
        result.include("version", version);
        final List<String> info = getSys.SystemInformation();
        result.include("jvmName", info.get(2));
        result.include("jvmVendor", info.get(1));
