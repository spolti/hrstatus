                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-md-5 border-right">
                        <dl>
                            ...
                            <dd><a href="https://github.com/hrstatus/hrstatus/issues/new" target="_blank"> Registrar Issue </a></dd>
                            <dt>Documentação</dt>
                            <dd><a href="${pageContext.request.contextPath}/doc/DocumentacaoHrStatus.pdf" target="_blank"> Vizualizar </a></dd>
                        </dl>
                    </div>
            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseNine" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li class="active"><a href="${pageContext.request.contextPath}/home/about">Sobre</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
