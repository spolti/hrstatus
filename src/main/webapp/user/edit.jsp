    ...
    <div class="row">
        <div class="col-sm-9 col-md-10 col-sm-push-3 col-md-push-2">
            ...
            <form method="POST" class="form-horizontal"
                  action="${pageContext.request.contextPath}/rest/user/update-nonadmin">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="radio">
                            <label>
                                <input readonly name="enabled" type="radio" name="optionsRadios" id="optionsRadios1" value="true"
                        ...
                        <div class="radio">
                            <label>
                                <input readonly name="enabled" type="radio" name="optionsRadios" id="optionsRadios2"
